...
export default function Cadastro() {
  const handleOAuthSignup = (provider: string) => {
    // Redireciona para o endpoint OAuth do Manus
    window.location.href = `/api/oauth/login?provider=${provider}`;
  };
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <Button
              ...
              className="w-full bg-[#1877F2] hover:bg-[#166FE5] text-white font-medium py-6 flex items-center justify-center gap-3"
            >
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-slate-800/50 text-purple-300">ou</span>
            </div>
          </div>

          {/* Email Signup (placeholder - will be implemented later) */}
          <div className="text-center">
            <p className="text-purple-300 text-sm mb-4">
              Cadastro por email em breve
            </p>
          </div>
