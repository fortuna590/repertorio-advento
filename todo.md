# TODO - Repertório Advento

## Funcionalidades Principais

- [x] Design católico com tema roxo/dourado do Advento
- [x] Página inicial com título e introdução
- [x] Lista de 12 momentos da missa organizados
- [x] Cards para cada música com nome, artista, links YouTube e Cifra Club
- [x] Filtro/navegação por momento da missa
- [x] Design responsivo para mobile
- [x] Ícones católicos e tema visual apropriado
- [x] Observações especiais (Glória no Natal, Epifania)
- [x] Footer com informações

## Melhorias Futuras

- [ ] Busca por nome de música ou artista
...
## Ajustes de Navegação e Menu

- [x] Remover links desnecessários APENAS de Repertorio.tsx
- [x] Criar header moderno reutilizável com botão voltar
- [x] Adicionar header em Repertorio.tsx
- [x] Adicionar header em Blog.tsx
- [ ] Adicionar header em Depoimentos.tsx
- [ ] Adicionar header em Produtos.tsx
